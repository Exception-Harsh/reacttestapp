...
//           const rowArray = row as (string | number | undefined)[]; // Explicitly type the row as an array
//           const rowData: GridData = { id: index + 1 };
//           headers.forEach((header, i) => {
//             rowData[header || `column_${i}`] = rowArray[i] || '';
//           });
//           return rowData;
//         });
...
//             onPaginationModelChange={(model) => setPaginationModel(model)} // Define available options for rows per page
//           />
//         </div>
//       )}
//     </div>
